...
// DmZ to PrZ
from_DmZ :: FromDevice(napt11-eth1, METHOD LINUX, SNIFFER false);
to_PrZ :: Queue -> counter_to_PrZ -> ToDevice(napt11-eth2);


// PrZ to DmZ
from_PrZ :: FromDevice(napt11-eth2, METHOD LINUX, SNIFFER false);
to_DmZ :: Queue -> counter_to_DmZ -> ToDevice(napt11-eth1);
